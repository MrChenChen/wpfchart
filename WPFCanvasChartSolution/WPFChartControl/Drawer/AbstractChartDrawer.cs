...
namespace IgorCrevar.WPFChartControl.Drawer
{
    ...
    public abstract class AbstractChartDrawer : IWPFCanvasChartDrawer
    {
        ...
        public Action<double, double> MouseOverCallBack;
        public Action<double, double> MouseDownCallBack;
        ...
        public Visibility PostionVisibility { get; set; }
        public IList<LegendItem> Legend { get; set; }
        public bool ShowLegendIten { get; set; }
        ...
        {
            if (MouseOverCallBack != null) MouseOverCallBack(x, y);
        }

        public virtual void OnChartMouseDown(double x, double y)
        {
            if (MouseDownCallBack != null) MouseDownCallBack(x, y);
        }
    }
}
